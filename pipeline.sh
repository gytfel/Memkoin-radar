...
if [ "$SKIP_DISCOVER" -eq 0 ]; then
    step "3/5  Ищу ранних покупателей (5-15 минут)"
...
[ -s candidates.txt ] || die "candidates.txt пуст. Добавь минтов в mints.txt и
запусти снова: по одному-двум токенам кандидатов почти не бывает."
